          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  ' I accepted',
                  style: TextStyle(fontFamily: "Poppins", color: Colors.blueGrey, fontWeight: FontWeight.bold),
                ),
                Text(" Terms & Privacy Policy", style: TextStyle(fontFamily: "Poppins",color: Colors.grey, fontWeight: FontWeight.bold),),
              ],
            ),
            SizedBox(
              height: 30,
